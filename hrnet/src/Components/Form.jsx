        ...
        <div>
            <form id="createEmployee"  onSubmit={handleSubmit(onSubmit)}>
                    <Fieldset title="Identity" attribut="fieldsetIdentity">
                        <Input htmlFor='firstName' className='firstName' title='First Name' type='text' id='firstName' name='firstName' 
                            register={register} required errors={errors.firstName}/>
                        <Input htmlFor='lastName' className='lastName' title='Last Name' type='text' id='lastName' name='lastName' 
                            register={register} required errors={errors.lastName}/>
                        <DatePicker htmlFor='dateOfBirth' className='dateOfBirth' title='Date of Birth' type='date' name='dateOfBirth' 
                            register={register} required errors={errors.dateOfBirth}/>
                        <DatePicker htmlFor='startDate' className='startDate' title='Start Date' type='date' name='startDate' 
                            register={register} required errors={errors.startDate}/>
                    </Fieldset> 

                    <Fieldset title="Address" attribut="fieldsetAdress">
                        <Input htmlFor='street' className='street' title='Street' type='text' id='street' name='street' 
                            register={register} required errors={errors.street}/>
                        <Input htmlFor='city' className='city' title='City' type='text' id='city' name='city' 
                        ...
                        <Input htmlFor='zipCode' className='zipCode' title='Zip Code' type='number' id='zipCode' name='zipCode' 
                    ...
                    <button form="createEmployee" className="btnSave" type='submit' ref={buttonOpen} onClick={saveEmployee}>Save</button>
                </form>
